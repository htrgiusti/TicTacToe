...
function placeXOrO(squareNumber) {
    ...
    // The .some() method is used to check each element of selectedSquare array to see if contains the square number clicked on.
    ...
    function checkWinConditions() {
        ...
        function arrayIncludes(squareA, squareB, squareC) {
            ...
            // If the 3 variables we pass are all includede in our array true is
